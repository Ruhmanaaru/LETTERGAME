...
public class TestResultAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.questionsTextView = convertView.findViewById(R.id.listview);
            viewHolder.selectionsTextView = convertView.findViewById(R.id.listview);
            viewHolder.correctAnswersTextView = convertView.findViewById(R.id.listview);
            viewHolder.scoreTextView = convertView.findViewById(R.id.listview);
